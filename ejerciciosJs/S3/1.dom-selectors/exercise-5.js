...
const testMe = document.querySelectorAll('[data-function ="testMe"]')              // .querySelectorAll busca todos los elementos que tengan la propiedad data-function ="testMe"

for (element of testMe){
  console.log(element);
}